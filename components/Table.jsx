...
function Table() {
  const students = [
    ...
    { id: 4, name: 'Ana Mendoza', evaluation: 77, absences: 2 },
    { id: 5, name: 'Ana Mendoza', evaluation: 68, absences: 5 },
    { id: 6, name: 'Ana Mendoza', evaluation: 98, absences: 0 },
    { id: 7, name: 'Ana Mendoza', evaluation: 58, absences: 5 },
  ];
