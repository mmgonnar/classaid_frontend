...
function Login() {
  return (
    <section className="flex min-h-screen items-center justify-center bg-[linear-gradient(345deg,rgba(101,156,246,0.3),rgba(246,246,246,0.2))]">
      <div className="container mx-auto hidden max-w-4xl flex-col justify-between gap-6 px-30 text-neutral-700 md:flex md:w-3/5">
      ...
      <div className="flex flex-col justify-center gap-4 rounded rounded-s-xl bg-white p-6 shadow-2xl md:min-h-screen md:w-2/5 md:p-20">
        ...
        <div className="pb-7 text-neutral-700">
          <h3 className="pb-2 text-xl md:pb-4">Welcome back!</h3>
